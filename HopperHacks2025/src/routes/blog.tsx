...
const blogPosts = [
  {
    ...
    date: "May 15, 2021",
    summary:
      "Learn how to interpret food labels and make informed decisions about your food purchases. Research shows that consumers increasingly value transparency in food labeling.",
  ...
  },
  {
    ...
    date: "-----",
    summary:
      "Organic products reduce public health risks by minimizing exposure to toxic chemicals in food, soil, air, and water. Discover how organic choices protect both consumers and farm workers.",
  ...
  },
  {
    ...
    date: "May 19, 2022",
    summary:
      "Explore the environmental and health implications of GMOs in our food system, and why many consumers are choosing non-GMO alternatives for their families.",
  ...
  },
  {
    ...
    date: "Fall 2003",
    summary:
      "Discover why pasture-raised animals produce healthier meat and dairy products, with higher levels of beneficial nutrients like omega-3 fatty acids and vitamins.",
  ...
  },
  {
    ...
    date: "-----",
    summary:
      "Learn about the three main benefits of choosing 100% grass-fed beef: humane treatment of animals, environmental sustainability, and superior nutritional value.",
            ...
            >
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  {/* <span className="text-sm text-[#37474F]/60 dark:text-gray-400">
                    {post.readTime}
                  </span> */}
                </div>
