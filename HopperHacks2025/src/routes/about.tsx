  ...
  return (
    <div className="min-h-screen pt-28 md:pt-32 bg-[#FAF3E0] dark:bg-gray-900 p-8 transition-colors duration-200">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section>
          <h2 className="text-3xl font-bold text-[#2E7D32] dark:text-[#4CAF50] mb-4 transition-colors duration-200">Our Mission</h2>
          <p className="text-[#37474F] dark:text-gray-300 text-lg leading-relaxed transition-colors duration-200">
        ...
        <section>
          <h2 className="text-3xl font-bold text-[#2E7D32] dark:text-[#4CAF50] mb-4 transition-colors duration-200">How It Works</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-[#2E7D32] dark:text-[#4CAF50] mb-4 transition-colors duration-200">Why It Matters</h2>
          <p className="text-[#37474F] dark:text-gray-300 text-lg leading-relaxed transition-colors duration-200">
